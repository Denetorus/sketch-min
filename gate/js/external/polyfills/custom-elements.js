!(function () {
  ...
  var r = !0,
        ...
        i = function (n, r) {
          ...
          if (r)
            for (
              ...
              l.call(n, (a = y[i])) &&
                (t.has(n) || t.set(n, new f()),
                (o = t.get(n)).has(a) || (o.add(a), e.handle(n, r, a)));
          else
            t.has(n) &&
              ((o = t.get(n)),
              t.delete(n),
        ...
        y.length && p(g[l](y)),
        {
          ...
          flush: function () {
            for (var e = m.takeRecords(), t = 0, n = e.length; t < n; t++)
              p(v.call(e[t].removedNodes, h), !1),
                p(v.call(e[t].addedNodes, h), !0);
          },
          observer: m,
          parse: p,
        }
    ...
    k = function (e) {
      for (var t = I(e), n = [], r = t.length, o = 0; o < r; o++)
        (n[o] = e[t[o]]), delete e[t[o]];
      return function () {
  ...
  if (P) {
    ...
    (self.customElements = {
      ...
      q((x.prototype = M.prototype), "constructor", {
        value: x,
      }),
      (self.HTMLElement = x),
  ...
  } else if ((P = !self.customElements.get("extends-li")))
    try {
      var B = function e() {
      ...
      var G = "extends-li";
      self.customElements.define("extends-li", B, {
        extends: "li",
      }),
        (P =
          g
  ...
  if (P) {
    var X = function (e) {
      ...
      pe = p({
        ...
        handle: function (e, t) {
          ae.has(e) &&
            (t ? le.add(e) : le.delete(e), de.length && X.call(de, e));
        },
      }).parse,
    ...
    D(self)
      ...
      .forEach(function (e) {
        ...
        q((n.prototype = t.prototype), "constructor", {
          value: n,
        }),
          q(self, e, {
            value: n,
      ...
      (Y.define = function (e, t, n) {
        ...
        ie.set(
          ...
          ge(e).then(function () {
            o
              ? (ve(g.querySelectorAll(r)), le.forEach(X, [r]))
